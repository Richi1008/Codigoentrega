...
const producto1 = new Producto(1, "Cafe_Con_Leche", "Le cafe", 120, 40)
const producto2 = new Producto(2, "Cafe_Con_Chocolate", "Nescafe", 110, 40)
const producto3 = new Producto(3, "Cafe_Expreso", "Nespresso", 99, 40)
const producto4 = new Producto(4, "Tisana", "Marina", 61, 40)
const producto5 = new Producto(5, "Chocolate_Semi_Amargo", "Le cafe", 600, 40)
const producto6 = new Producto(6, "Cafe_Americano", "Le cafe", 156, 40)



function comprartodo(compra, cantidad, Total1, producto1, producto2, producto3, producto4, producto5, producto6 ){
    switch(compra) {
        case 1:
